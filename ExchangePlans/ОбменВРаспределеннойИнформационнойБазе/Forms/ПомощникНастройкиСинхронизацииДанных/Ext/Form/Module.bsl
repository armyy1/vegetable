...
Процедура ПриНачалеСохраненияНастройкиСинхронизацииНаСервере(ПродолжитьОжидание)
	...
	НастройкиСинхронизации.ДанныеЗаполнения.Вставить("МестаХранения",        Склады.Выгрузить());
...
Процедура ИнициализироватьРеквизитыФормы()
	...
	Запрос = Новый Запрос(
	"ВЫБРАТЬ
	|	ОбменВРаспределеннойИнформационнойБазе.ДатаНачалаВыгрузкиДокументов КАК ДатаНачалаВыгрузкиДокументов,
	|	ОбменВРаспределеннойИнформационнойБазе.ИспользоватьОтборПоОрганизациям КАК ИспользоватьОтборПоОрганизациям,
	|	ОбменВРаспределеннойИнформационнойБазе.ИспользоватьОтборПоСкладам КАК ИспользоватьОтборПоСкладам,
	|	ОбменВРаспределеннойИнформационнойБазе.ИспользоватьОтборПоПодразделениям КАК ИспользоватьОтборПоПодразделениям,
	|	ОбменВРаспределеннойИнформационнойБазе.Организации.(
	|		Организация КАК Организация
	|	) КАК Организации,
	|	ОбменВРаспределеннойИнформационнойБазе.МестаХранения.(
	|		СкладОтправитель КАК СкладОтправитель,
	|		СкладПолучатель КАК СкладПолучатель
	|	) КАК МестаХранения,
	|	ОбменВРаспределеннойИнформационнойБазе.Подразделения.(
	|		Подразделение КАК Подразделение
	|	) КАК Подразделения
	|ИЗ
	|	ПланОбмена.ОбменВРаспределеннойИнформационнойБазе КАК ОбменВРаспределеннойИнформационнойБазе
	|ГДЕ
	|	ОбменВРаспределеннойИнформационнойБазе.Ссылка = &Ссылка");
