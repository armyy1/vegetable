...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ДанныеЗаполнения = Неопределено Тогда // Ввод нового.
		СтандартныеПодсистемы.ПриВводеНовогоЗаполнитьОрганизацию(ЭтотОбъект);
	КонецЕсли;
...
Процедура СформироватьДвиженияВРеестрДокументов()
	...
	Движение = РегистрыСведений.РеестрДокументов.СоздатьМенеджерЗаписи();
...
Процедура СформироватьДвиженияПоМестамХранения()
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Движение.Склад         = МестоХраненияИсточник;
		
		Движение.Номенклатура  = СтрокаТовары.Номенклатура;
		Движение.ВидОпераций   = Перечисления.ВидыОперации.Перемещение;
		...
		Движение.Склад         = МестоХраненияПриемник;
