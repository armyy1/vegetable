...
Функция ТекстЗапросаСпискаСЗащитойПерсональныхДанных()
	Возврат "ВЫБРАТЬ
	|	СправочникФизическиеЛицаПереопределяемый.Ссылка КАК Ссылка,
	|	СправочникФизическиеЛицаПереопределяемый.ПометкаУдаления КАК ПометкаУдаления,
	|	СправочникФизическиеЛицаПереопределяемый.Родитель КАК Родитель,
	|	СправочникФизическиеЛицаПереопределяемый.ЭтоГруппа КАК ЭтоГруппа,
	|	СправочникФизическиеЛицаПереопределяемый.Наименование КАК Наименование,
	|	СправочникФизическиеЛицаПереопределяемый.ДатаРождения КАК ДатаРождения,
	|	СправочникФизическиеЛицаПереопределяемый.Пол КАК Пол,
	|	СправочникФизическиеЛицаПереопределяемый.МестоРождения КАК МестоРождения,
	|	СправочникФизическиеЛицаПереопределяемый.Гражданство КАК Гражданство,
	|	СправочникФизическиеЛицаПереопределяемый.СерияДокумента КАК СерияДокумента,
	|	СправочникФизическиеЛицаПереопределяемый.НомерДокумента КАК НомерДокумента,
	|	СправочникФизическиеЛицаПереопределяемый.КемВыданДокумент КАК КемВыданДокумент,
	|	СправочникФизическиеЛицаПереопределяемый.КодПодразделенияДокумента КАК КодПодразделенияДокумента,
	|	СправочникФизическиеЛицаПереопределяемый.ДатаВыдачиДокумента КАК ДатаВыдачиДокумента,
	|	СправочникФизическиеЛицаПереопределяемый.СНИЛС КАК СНИЛС,
	...
	|	КОНЕЦ КАК ПДнСкрыты
	|ИЗ
	|	Справочник.ФизическиеЛица КАК СправочникФизическиеЛицаПереопределяемый
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СубъектыДляСкрытияПерсональныхДанных КАК СубъектыСоКрытымиПДн
	|		ПО СправочникФизическиеЛицаПереопределяемый.Ссылка = СубъектыСоКрытымиПДн.Субъект
