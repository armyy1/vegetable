...
Процедура ПриПодготовкеШаблонаСообщения(Реквизиты, Вложения, ДополнительныеПараметры) Экспорт
	...
	ШаблоныСообщений.РазвернутьРеквизит("Контрагент", Реквизиты, "", "ГруппаДоступа");
...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|ГДЕ
	|	ЭтоГруппа
	|	ИЛИ ЗначениеРазрешено(Контрагент)";
	...
	|	ПО ВнешниеПользователиПартнеры.ОбъектАвторизации = Контрагенты.Контрагент
	|
	|ЛЕВОЕ СОЕДИНЕНИЕ Справочник.КонтактныеЛицаПартнеров КАК КонтактныеЛицаПартнеров
	|	ПО КонтактныеЛицаПартнеров.Владелец = Контрагенты.Контрагент
	|
