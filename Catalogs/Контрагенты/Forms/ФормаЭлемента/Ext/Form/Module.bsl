...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппыДляРазмещения.Добавить(УправлениеСвойствами.НаборСвойствПоИмени("СправочникКонтрагенты_Основное"), Элементы.ГруппаОсновное.Имя);
	...
	ИсключаемыеВиды.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("EmailКонтрагента"));
	ИсключаемыеВиды.Добавить(УправлениеКонтактнойИнформацией.ВидКонтактнойИнформацииПоИмени("SkypeКонтрагента"));
